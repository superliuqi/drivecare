...
<div class="succ">
    ...
    <img src="{{url()}}/images/close.png"  id="CloseApp" > 
...
<script>
    $(function(){
        countDown();
        $('.bk,.logo,h1,h3,.exit,p').click(function() {
            clearTimeout(stopnum);
            $('.exit').html('点击关闭').css('margin-left', '-3rem');
            ClickCloseApp();
        });
    });
    ...
    var num=parseInt($(".exit span").html());
        ...
        stopnum = setTimeout(function(){countDown();},1000);
        }else{
            closeApp();
        }
    }
